module SvgVisualization exposing (..)
...
nodeStroke : Stroke
nodeStroke = Stroke Color.darkBlue 1
...
gridStroke : Stroke
gridStroke = Stroke Color.lightBlue 0.15
