...
init elmFiles =
    let basic = Graph.nodes elmFiles |> Debug.log "elms"
    ...
    in case basic of 
        ...
        Just b ->
            let smaller = Graph.inducedSubgraph [b.id] elmFiles
            in (Graph.mapNodes CompilationUnit.init smaller,
